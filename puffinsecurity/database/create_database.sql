...
--
-- Host: 127.0.0.1
-- Generation Time:  6 юли 2020 в 21:33
...
--
-- Database: `id13923848_puffinsecurity`
--
CREATE DATABASE id13923848_puffinsecurity;
-- --------------------------------------------------------
use id13923848_puffinsecurity;
--
...
CREATE TABLE `comments` (
  ...
  `referat_id` varchar(255) COLLATE utf8_bin NOT NULL,
...
CREATE TABLE `events` (
  ...
  `device_type` varchar(255) COLLATE utf8_bin NOT NULL,
...
--
-- Структура на таблица `tbl_www_14ed_referats`
--

CREATE TABLE `tbl_www_14ed_referats` (
  `id` mediumint(9) NOT NULL,
  `name` char(30) COLLATE utf8_bin NOT NULL,
  `command_text` text COLLATE utf8_bin DEFAULT NULL,
...
--
-- Структура на таблица `user_failed_logins`
--
...
--
-- Indexes for table `tbl_www_14ed_referats`
--
ALTER TABLE `tbl_www_14ed_referats`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `tbl_www_14ed_referats`
--
ALTER TABLE `tbl_www_14ed_referats`
